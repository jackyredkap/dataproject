...
<?php
	...
	if($_GET["Action"] == "Del")
{
	$strSQL = "DELETE FROM detailproject ";
	$strSQL .="WHERE ProjectID = '".$_GET["ProID"]."' ";
...
<center>
	...
	<table border="1" style="border-collapse:collapse; border: solid #696969; background-color: #CFCFCF;">
		...
		<td style="border-collapse:collapse; border: solid #696969;"><select name="lmName12"><option>แก้ไข</option></select></td>
		<td style="border-collapse:collapse; border: solid #696969;"><select name="lmName13"><option>ลบ</option></select></td>
		</tr>
<?php
...
<?php
	if($objResult["ProjectID"] == $_GET["ProID"])
	{
?>
...
?>
	...
	<td align="center"><a style="text-decoration: none;" href="EditAdmin.php?ID=<?=$objResult["ProjectID"];?>">แก้ไข</a></td>
	<td align="center"><a style="text-decoration: none;" href="JavaScript:if(confirm('โปรดยืนยันการลบข้อมูล?')==true){window.location='<?php echo $_SERVER["PHP_SELF"];?>?Action=Del&ProID=<?php echo $objResult["ProjectID"];?>';}">ลบ</a></td>
	</tr>
	<?
	}
	?>
