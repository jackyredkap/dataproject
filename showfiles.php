...
<?php
		...
		<td style="border-collapse:collapse; border: solid #696969;"><select name="lmName6"><option>ลบ</option></select></td>
		</tr>
<?
...
<td align="center"><a style="text-decoration: none;" href="Editfiles.php?ID=<?=$objResult["FilesID"];?>">แก้ไข</a></td>
	<td align="center"><a style="text-decoration: none;" href="JavaScript:if(confirm('โปรดยืนยันการลบข้อมูล?')==true){window.location='<?php echo $_SERVER["PHP_SELF"];?>?Action=Del&fID=<?php echo $objResult["FilesID"];?>';}">ลบ</a></td>
</tr>
<?
	}
?>
